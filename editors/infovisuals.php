...
function pageContentArea() {
    ...
    <div class='col-xs-12 col-sm-9 col-md-9 col-lg-10 bodySpace'>
        <h5>&nbsp;&nbsp;InfoVisual Editor : <span id='dcTitle'></span> <div id='dcTags' class='pull-right' style='margin-right:10px;'></div></h5>
        <ul class='nav nav-tabs nav-justified'>
            <li class='active'><a href='#editorDesigner' data-toggle='tab' role='tab' aria-controls='nav-editorDesigner' aria-selected='false'>Designer</a></li>
            ...
            <li><a href='#editorProperties' data-toggle='tab' role='tab' aria-controls='nav-editorProperties' aria-selected='true'>Properties</a></li>
        </ul>
        <div class='tab-content'>
            <div id='editorDesigner' class='table-responsive tab-pane fade'>Designer
            </div>
    ...
    <div class='col-xs-12 col-sm-3 col-md-3 col-lg-2 sidebarSpace'>
        <ul class='nav nav-tabs nav-justified'>
            <li class='active'><a href='#tabList' data-toggle='tab' role='tab' aria-controls='nav-tabList' aria-selected='true'>Design Blocks</a></li>
        </ul>
        <div class='tab-content'>
            <div id='tabList' class='tab-pane fade in active'>
                <div id='blockTree' class='componentTree list-group list-group-root'>
